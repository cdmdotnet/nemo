...
#define NEMO_FILE_MANAGEMENT_PROPERTIES_SHOW_PREVIEW_PANE_ICON_TOOLBAR_WIDGET  "show_preview_pane_icon_toolbar_togglebutton"
                                              ...
                                              const gchar *initial_page)
{
    ...
    bind_builder_bool (builder, nemo_preferences,
        NEMO_FILE_MANAGEMENT_PROPERTIES_SHOW_PREVIEW_PANE_ICON_TOOLBAR_WIDGET,
        NEMO_PREFERENCES_SHOW_PREVIEW_PANE_TOOLBAR);
    bind_builder_bool (builder, nemo_preferences,
